...
type IOCFound struct {
	...
	ProgressStatus string            `json:"progress_status,omitempty"` // Used to track scan progress
}
...
func WriteScanData(malwares []*pb.MalwareInfo, scanID string, progressStatus string) {
